...
def make_bucketed_loader(dataset, map, val_size=0.2, batch_size=32, seed=4):
  '''
    Creates train and validation DataLoader for the given dataset, \
    separating features into independent/correlated, sensitive, and descendant features, and stratified by target class.
